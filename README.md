...
Feedback is best provided as [a GitHub issue](https://github.com/opendata/CKAN-Multisite/issues). Or, if you prefer privacy, they can be sent [to Waldo Jaquith via e-mail](mailto:waldo@usopendata.org).

[Further information is available on the U.S. Open Data blog](https://usopendata.org/2014/12/08/ckan-multisite/).
